...
if scat_button: #al hacer clic en el botón
    #escribir mensaje
    st.write("Creación de un gráficode dispersion para el conjunto de datos de anuncions de venta de automóviles")

    #crear el gráfico de dispersion
    fig =px.scatter(car_data, x="Odómetro", y="Precio")
